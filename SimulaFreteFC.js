function ShowCEP(IDProduto){
  ...
  if(sNumCEP==null)sNumCEP="";
   sCEP="<style>";
  sCEP+="/* Zip Code */";
  sCEP+=".ZipBackground{border:1px solid #eaeaea;background:#e5e5e5;padding:1px 1px 1px 1px;}";
  sCEP+=".ZipTitCalc{background-color:#b2b2b2;height:30px;font-size:10px;color:#fcfcfc;font-family:Calibri;font-weight:bold}";
  sCEP+=".ZipTitType{font-size:12px;color:#666666;font-family:Calibri;}";
  ...
  sCEP+=".ZipName{font-size:12px;color:#373737;font-family:Calibri;font-weight:bold;margin-top:2px;}";
  sCEP+=".ZipObsVal{font-size:12px;color:#373737;font-family:Calibri;}";
  sCEP+=".ZipValue{font-size:12px;color:#014282;font-family:Calibri;font-weight:bold}";
  sCEP+="</style>";
  sCEP+="<table border='0' cellpadding='0' width='500' cellspacing='0' class='ZipBackground'>";
  sCEP+="  <tr class='ZipTitCalc'>";
  sCEP+="    <td align='center'>Calcule o valor do frete deste produto para sua localidade:</td>";
  sCEP+="  </tr>";
  sCEP+="  <tr height='40'>";
...
function processXMLCEP(obj,IDProd){
  ...
  sShipping+="<tr><td class='ZipName'>A Melhor Opção:&nbsp;&nbsp;&nbsp;&nbsp;"+ ReadXMLNode(obj,"Opt1Name") +"</td><td class='ZipObsVal'>"+ ReadXMLNode(obj,"Opt1Obs") +"</td><td class='ZipValue' align='right'>"+ sValorFrete +"</td></tr>";
  sShipping+="</table>";
